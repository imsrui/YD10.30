<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/Shared/Leyout.Master" AutoEventWireup="true" CodeBehind="Order_List.aspx.cs" Inherits="WebApp.Admins.Order.Order_List" %>
     ...
     <div class="row mb-1">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-4">
                ...
                <a href="Order_Add.aspx" class="btn btn-success">Insert</a>
                        ...
                        <asp:Repeater ID="RepOrderList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td> 
                                        <td>
                                            <%#Eval("Order_Content").ToString().Length > 50 ? Eval("Order_Content").ToString().Substring(0,50)+"..." : Eval("Order_Content").ToString()  %>
                                        </td>
                                        <%#Eval("Order_WebMenusId") %>
                                    </td>
                                    
                                    <td>
                                        <a class="btn btn-warning" href='Order_Edit.aspx?action=<%#Eval("Order_Id") %>'>
