<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/Shared/Leyout.Master" AutoEventWireup="true" CodeBehind="SystemMenus_Edit.aspx.cs" Inherits="WebApp.Admins.SystemMenus.SystemMenus_Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>编辑系统菜单信息</title>
    <style>
        .info {
            text-align: center;
            padding: 20px 0px;
        ...
        <div class="col-md-offset-1 col-md-10">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title">编辑系统菜单</h3>
                </div>
