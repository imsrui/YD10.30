<%@ Page Title="" Language="C#" MasterPageFile="~/Admins/Shared/Leyout.Master" AutoEventWireup="true" CodeBehind="Menus_List.aspx.cs" Inherits="WebApp.Admins.Menu.Menus_List" %>
    ...
    <div class="row mb-1">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-4">
                ...
                <a href="Menu_Add.aspx" class="btn btn-success">Insert</a>
                        ...
                        <asp:Repeater ID="RepMenuList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href='Menu_Edit.aspx?action=<%#Eval("Menu_Id") %>'>
                                            <span class="lnr lnr-pencil"></span> 修改
                                        </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger" href='Menu_Remove.aspx?action=<%#Eval("Menu_Id") %>'>
