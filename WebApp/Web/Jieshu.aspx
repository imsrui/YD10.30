<%@ Page Title="" Language="C#" MasterPageFile="~/Web/LayOut.Master" AutoEventWireup="true" CodeBehind="Jieshu.aspx.cs" Inherits="WebApp.Web.Jieshu" %>
        ...
        <div class="jieshu_1">
            ...
            <div class="jieshu_2">
                <div class="jieshu_2_1">
                    <a href="#">
                        <img src="assets/images1/shu1.jpg" /></a>
                </div>
                <div class="jieshu_2_2">
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <h2><a href="#"><%#Eval ("Free_Name") %></a></h2>
                            <h3><%#Eval ("Free_Title") %></h3>
                            <ul>
                                <li><%#Eval("Free_Content") %>   </li>
                            </ul>
                        </ItemTemplate>
                    </asp:Repeater>
                ...
                <div class="jieshu_2">
                     <div class="jieshu_2_1"><a href="#">
                        <img src="assets/images1/shu1.jpg" /></a></div>
                    <div class="jieshu_2_2">
